 ...
 * @class PingPongRight
 * 
 * @brief This class implements a Java program that creates two instances of the PlayPingPongThread and start these
 *        thread instances to correctly alternate printing "Ping" and "Pong", respectively, on the console display.
 */
public class PingPongRight {
     ...
     * 
     * @brief This class implements the ping/pong processing algorithm using the SimpleSemaphore to alternate printing
     *        "ping" and "pong" to the console display.
     */
    public static class PlayPingPongThread extends Thread {

        /**
         * Constants to distinguish between ping and pong SimpleSemaphores, if you choose to use an array of
         * SimpleSemaphores. If you don't use this implementation feel free to remove these constants.
         */
        ...
        /**
         * Two SimpleSemaphores use to alternate pings and pongs. You can use an array of SimpleSemaphores or just
         * define them as two data members.
         */
        // TODO - You fill in here.
         ...
         */
        public PlayPingPongThread(final String stringToPrint,
                final SimpleSemaphore semaphoreOne,
        ...
        /**
         * Main event loop that runs in a separate thread of control and performs the ping/pong algorithm using the
         * SimpleSemaphores.
         */
        @Override
        public void run() {
            /**
             * This method runs in a separate thread of control and implements the core ping/pong algorithm.
             */
            // TODO - You fill in here.
            for (int loopsDone = 1; loopsDone <= mMaxIterations; ++loopsDone) {
                ...
                // subclasses.
                acquire();
                System.out.println(this.mStringToPrint + "(" + loopsDone + ")");
                release();
            }
     ...
     */
    public static void process(final String startString,
            final String pingString,
            final String pongString,
            final String finishString,
            final int maxIterations) throws InterruptedException {
